...
export const metadata = {
  title: "Construction Jobs in Bharuch | Careers at Shubh Construction",
  description:
    "Apply for civil engineer, supervisor, and project manager jobs at Shubh Construction in Bharuch, Gujarat. Upload your resume and join our growing team.",
};
const JobApp = [
  {
    title: "Full Name",
...
const page = () => {
  ...
  <div>
    ...
    <p className="text-gray-600 mt-2">Yes, we hire for multiple on-site roles in Bharuch, Gujarat.</p>
  </div>

  <div>
    <strong>How can I apply?</strong><br />
    <p className="text-gray-600 mt-2">Fill out the form and upload your resume.</p>
  </div>
</section>
  ...
  Job Location: Bharuch, Gujarat, India
    ...
    className="space-y-6">
      <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Apply Here</h2>
      {
  ...
  <input
    ...
    className="w-full border border-gray-300 rounded-md px-4 py-2
               ...
               hover:file:bg-red-800" required
  />
</div>

    </div>
    <button type="submit" className="text-white w-full bg-red-600 active:scale-95 hover:bg-red-700 hover:scale-105 transition-all duration-300 px-4 py-2 rounded-xl ">Submit Your Application</button>
    </form>
    </AnimateOnScroll>
</section>
</main>
